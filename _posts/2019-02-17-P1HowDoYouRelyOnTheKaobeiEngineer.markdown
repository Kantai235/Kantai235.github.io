...
author     : "乾太 ₍₍ ◝(･◡･)◟ ⁾⁾"
tags       : Laravel 後端 架構 Repostory Service Presenter Middleware Request Validation 監聽器 監聽器事件 觀察者 觀察者模式 Helpers RESTful 資料標準化 Transformer Formatter Hypermedia
comments   : true
signature  : true
---
