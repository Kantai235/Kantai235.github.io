...
slug: android-safety-net-re-captchaapi
description: Google上周五（6/9）釋出了支援Android平台的reCAPTCHA API，此一API採用的是Google甫於今年3月發表的隱形reCAPTCHA技術，可於背景辨識用戶是真人或機器人，去除用戶使用行動程式的障礙
  ...
summary: Google上周五（6/9）釋出了支援Android平台的reCAPTCHA API，此一API採用的是Google甫於今年3月發表的隱形reCAPTCHA技術，可於背景辨識用戶是真人或機器人，去除用戶使用行動程式的障礙

date: '2017-06-13T00:00:00+08:00'
lastmod: '2017-06-13T00:00:00+08:00'
categories:
- 技術文件
- Android 實務
tags:
...
![成功連線到 Google Services](3.png)

## 啟用 reCAPTCHA 的樣子
![啟用 reCAPTCHA 的樣子](4.png)
