---
title: 【PHP 設計模式】工廠方法 Factory Method
slug: factory-method
...
summary: "以動物森友會大頭菜為例，學習工廠方法設計模式。透過定義工廠介面讓各個工廠去實作，解決物件建立的複雜性。工廠方法與抽象工廠的差異在於使用介面而非抽象類別。"

date: '2020-09-18T00:00:00+08:00'
lastmod: '2020-09-18T00:00:00+08:00'
categories:
- 技術文件
- PHP 設計模式
tags:
...
工廠方法定義一個建立物件的介面，但讓子類別決定要具現化哪一個類別。工廠方法讓類別的具現化延遲到子類別中進行。
{{< /alert >}}
...
- **工廠方法**: 使用介面定義工廠契約，具體工廠實作介面
- **抽象工廠**: 使用抽象類別定義工廠，並實作共用方法
{{< /alert >}}

## UML
{{< figure src="UML.png" alt="Factory Method UML 類別圖" caption="Factory Method 設計模式的 UML 類別關係圖" >}}
...
- [技術部落格文章 - 工廠方法](https://blog.init.engineer/posts/FactoryMethod)
