...
slug: how-to-create-google-no-captcha
description: 無論在手機應用程式或者網頁應用程式，你時常會看到「我不是機器人」或「請點選下面有包含汽車的圖」的功能，這功能其實來自於 Google 提供的
  ...
summary: 無論在手機應用程式或者網頁應用程式，你時常會看到「我不是機器人」或「請點選下面有包含汽車的圖」的功能，這功能其實來自於 Google 提供的

date: '2018-09-09T00:00:00+08:00'
lastmod: '2018-09-09T00:00:00+08:00'
categories:
- 技術文件
- Android 實務
tags:
