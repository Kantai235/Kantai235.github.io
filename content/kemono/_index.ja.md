...
<div class="kemono-container">
  ...
  <div id="background-after" class="kemono-background active">
    ...
    <img id="background-img-after" alt="今のうちの子" class="nozoom mt-0 mr-0 mb-0 ml-0 h-[1000px] w-full object-cover" style="display: none;">
  </div>
  <div id="background-before" class="kemono-background">
    ...
    <img id="background-img-before" alt="前のうちの子" class="nozoom mt-0 mr-0 mb-0 ml-0 h-[1000px] w-full object-cover" style="display: none;">
  </div>
  <div id="background-fursuit" class="kemono-background">
    ...
    <img id="background-img-fursuit" alt="ハーフ着ぐるみ" class="nozoom mt-0 mr-0 mb-0 ml-0 h-[1000px] w-full object-cover" style="display: none;">
  </div>
  ...
  <div class="kemono-tabs">
    ...
    <button class="kemono-tab" data-tab="fursuit">ハーフ着ぐるみ</button>
  </div>
  ...
  <div id="tab-after" class="kemono-tab-content active">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/ja/kemono/gallery/after/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">すべての作品を見る →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-before" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/ja/kemono/gallery/before/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">すべての作品を見る →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-fursuit" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/ja/kemono/gallery/fursuit/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">すべての作品を見る →</a>
      </div>
    </div>
  </div>
</div>
