...
<div class="kemono-container">
  ...
  <div id="background-after" class="kemono-background active">
    ...
    <img id="background-img-after" alt="现在的设定背景" class="nozoom mt-0 mr-0 mb-0 ml-0 h-[1000px] w-full object-cover" style="display: none;">
  </div>
  ...
  <div id="tab-after" class="kemono-tab-content active">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/zh-cn/kemono/gallery/after/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相册 →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-before" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/zh-cn/kemono/gallery/before/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相册 →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-fursuit" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/zh-cn/kemono/gallery/fursuit/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相册 →</a>
      </div>
    </div>
  </div>
</div>
