...
<div class="kemono-container">
  ...
  <div id="background-fursuit" class="kemono-background">
    ...
    <img id="background-img-fursuit" alt="半套獸裝背景" class="nozoom mt-0 mr-0 mb-0 ml-0 h-[1000px] w-full object-cover" style="display: none;">
  </div>
  ...
  <div class="kemono-tabs">
    ...
    <button class="kemono-tab" data-tab="fursuit">半套獸裝</button>
  </div>
  ...
  <div id="tab-after" class="kemono-tab-content active">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/kemono/gallery/after/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相簿 →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-before" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/kemono/gallery/before/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相簿 →</a>
      </div>
    </div>
  </div>
  ...
  <div id="tab-fursuit" class="kemono-tab-content">
    <div class="p-6 border-2 border-neutral-200 dark:border-neutral-700 rounded-lg background-white/90 dark:background-gray-800/90 backdrop-blur">
      ...
      <div class="mt-4 text-center">
        <a href="/kemono/gallery/fursuit/" class="inline-block px-4 py-2 rounded-lg text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors">查看完整相簿 →</a>
      </div>
    </div>
  </div>
</div>
